package ando.gallery.ucrop.view;
...
import ando.gallery.ucrop.callback.CropBoundsChangeListener;
import ando.gallery.ucrop.model.CropParameters;
import ando.gallery.ucrop.model.ImageState;
import ando.gallery.ucrop.task.BitmapCropTask;
import ando.gallery.ucrop.util.CubicEasing;
import ando.gallery.ucrop.util.RectUtils;
...
public class CropImageView extends TransformImageView {
    ...
    /**
     *  - maximum scale value for current image and crop ratio
     */
    ...
    /**
     *  - minimum scale value for current image and crop ratio
     */
     ...
     *
     *  - the float array of image indents (4 floats) - in this order [left, top, right, bottom]
     */
     ...
     *  - true if it wraps crop bounds, false - otherwise
     */
